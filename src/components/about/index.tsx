...
const contactList = [
  {
    icon: GithubSVG,
    link: "https://github.com/tuskermanshu"
  },
  {
    icon: TwitterSVG,
    link: "https://x.com/guai_dada12138"
  },
]
